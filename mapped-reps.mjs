export default {
  ...
  // nano_19qo4gtzpoyqf6zzezbcuazcsxtqtdin5qbtk8jkoz4fdmq4ssagn3u1odhz - trustable nn2 has dynamic ip
  // NF2
  '::ffff:94.16.109.134':
  ...
  // nano_35btiz1mgfwp95c3ckazmzbp5gepduxtijuijd9xebeau8u1gsbea41smjca - atomic wallet has dynamic ip
  // wenano
  '::ffff:78.47.124.255':
  ...
  // nano_3ngt59dc7hbsjd1dum1bw9wbb87mbtuj4qkwcruididsb5rhgdt9zb4w7kb9 - wirex rep running on two nodes?
  // nanolove
  '::ffff:188.165.216.204':
  ...
  // nf 7
  '2001:19f0:5801:1e2e:5400:3ff:fe5c:8a3c':
    'nano_1anrzcuwe64rwxzcco8dkhpyxpi8kd7zsjc1oeimpc3ppca4mrjtwnqposrs',
  // nano brasil
  '::ffff:177.66.167.199':
  ...
  // mimenode - multiple reps on single node
  /* '::ffff:134.209.200.73':
  ...
  // ?? - multiple reps on singel node
  /* '::ffff:139.162.199.142':
   *   'nano_16u1uufyoig8777y6r8iqjtrw8sg8maqrm36zzcm95jmbd9i9aj5i8abr8u5', */
  // fixing spam > code prettiness
  '::ffff:157.245.241.60':
  ...
  // 1nanonode.fr
  '::ffff:82.64.100.254':
    'nano_1aoxwfsmu6wazes9jq4xu695jx5txa3qrrfsrg4w4uk35bhmxkn378fwebng',
  // pixelstix
  '::ffff:164.90.136.60':
  ...
  '2a01:4f8:13b:119e::2':
    'nano_3pnanopr3d5g7o45zh3nmdkqpaqxhhp3mw14nzr41smjz8xsrfyhtf9xac77',
  // mimenode-old - multiple reps on single node
  /* '::ffff:134.209.200.73':
   *   'nano_139tfuxmn4xne7kac8gy46rzg3tj8dcahyjjrexk9pc8udh3i1cjxs1h5rme', */
  // nano wallet bot - multiple reps on single node
  /* '::ffff:139.162.199.142':
  ...
  // the crypto umbrella
  '::ffff:62.163.0.183':
    'nano_39gwh6ci76qpeqhsebg98nn75xour7komga39r9qn6mrmg99yajo4d7nrurw',
  // majorchump's node
  '::ffff:94.130.135.50':
  ...
  // ??
  '::ffff:37.205.12.210':
    'nano_3cxj9z11z1um61m51paiff4pw5fdttzmpojbwcr1hqbduwi4rqtjws7cxdc8',
  // scoin.cool
  '::ffff:165.232.158.215':
