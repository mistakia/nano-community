...
Nano is an experimental new currency that is in active development. Each improvement makes Nano more appealing but can also reveals new challenges as it operates in uncharted waters. You might encounter slow or delay confirmations, downtime, or even more severe issues.
